...
This project is [hosted on GitHub](https://github.com/blkanaki/.github). You can clone this project directly using this command:

```
git clone git@github.com:blkanaki/.github.git
```
...
Copyright (c) 2020 Samuel John

This project is licensed under GNU GPL v3 - see [LICENSE.md](LICENSE.md) file for details.

**[Back to top](#table-of-contents)**

# Authors

* **[Samuel John](https://github.com/blkanaki)**
